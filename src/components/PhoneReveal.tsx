  ...
  return (
    <section className="py-24 sm:py-32 border-t border-white/10 overflow-hidden relative">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 text-center">
        ...
        <p className="text-paper-dim max-w-md mx-auto mb-16 sm:mb-20 leading-relaxed">
          Shot vertical, turned widescreen — live, in a single continuous
          take from {VIMEO_TITLE}.
        </p>

        <div className="relative mx-auto w-[350px] h-[350px] sm:w-[435px] sm:h-[435px] lg:w-[520px] lg:h-[520px]">
          <motion.div
            animate={{ rotate: rotated ? -90 : 0 }}
            transition={{ duration: 1.1, ease: [0.65, 0, 0.35, 1] }}
            style={{ transformOrigin: "50% 50%" }}
            className="absolute inset-0 m-auto w-[160px] aspect-[9/19.5] sm:w-[200px] lg:w-[240px] rounded-[2.2rem] bg-ink-soft ring-1 ring-white/15 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.7)] p-[10px]"
          >
            {/* notch */}
